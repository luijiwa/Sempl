...
import 'package:chefshouse/common/mixin/theme_wm_mixin.dart';
import 'package:chefshouse/src/feature/{{feature_name.snakeCase()}}/di/{{feature_name.snakeCase()}}_scope.dart';
import 'package:chefshouse/src/feature/{{feature_name.snakeCase()}}/presentation/screens/{{screen_name.snakeCase()}}/{{screen_name.snakeCase()}}_model.dart';
import 'package:chefshouse/src/feature/{{feature_name.snakeCase()}}/presentation/screens/{{screen_name.snakeCase()}}/{{screen_name.snakeCase()}}_screen.dart';
